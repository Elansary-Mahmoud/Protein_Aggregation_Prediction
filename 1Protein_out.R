...
#save(list = ls(all=TRUE), file = "1_proteinout_new.RData")
...
FPR_tree_total = array(0,c(1,length(Proteins)))

print("Prediction of each protein based on Decision Tree")
for (i in 1:(length(Proteins)))
{
	print(paste("True Positive rate for Protein",Proteins[i]))
	print((TP_tree[1,i])/(TP_tree[1,i] + FN_tree[1,i]))
	print(TP_tree[1,i])
	print(paste("False Positive rate for Protein",Proteins[i]))
	print((FP_tree[1,i])/(FP_tree[1,i] + TN_tree[1,i]))
	FPR_tree_total[1,i] = (FP_tree[1,i])/(FP_tree[1,i] + TN_tree[1,i])
	print(FP_tree[1,i])
}

print("Prediction of each protein based on SVM")
for (i in 1:(length(Proteins)))
{
	print(paste("True Positive rate for Protein",Proteins[i]))
	print((TP_svm[1,i])/(TP_svm[1,i] + FN_svm[1,i]))
	print(TP_svm[1,i])
	print(paste("False Positive rate for Protein",Proteins[i]))
	print((FP_svm[1,i])/(FP_svm[1,i] + TN_svm[1,i]))
	print(FP_svm[1,i])
}

print("Prediction of each protein based on BRGLM")
for (i in 1:(length(Proteins)))
{
	print(paste("True Positive rate for Protein",Proteins[i]))
	print((TP_brglm[1,i])/(TP_brglm[1,i] + FN_brglm[1,i]))
	print(TP_brglm[1,i])
	print(paste("False Positive rate for Protein",Proteins[i]))
	print((FP_brglm[1,i])/(FP_brglm[1,i] + TN_brglm[1,i]))
	print(FP_brglm[1,i])
}


print("Prediction of each protein based on LDA")
for (i in 1:(length(Proteins)))
{
	print(paste("True Positive rate for Protein",Proteins[i]))
	print((TP_lda[1,i])/(TP_lda[1,i] + FN_lda[1,i]))
	print(TP_lda[1,i])
	print(paste("False Positive rate for Protein",Proteins[i]))
	print((FP_lda[1,i])/(FP_lda[1,i] + TN_lda[1,i]))
	print(FP_lda[1,i])
}

print("Prediction of each protein based on RF")
for (i in 1:(length(Proteins)))
{
	print(paste("True Positive rate for Protein",Proteins[i]))
	print((TP_rf[1,i])/(TP_rf[1,i] + FN_rf[1,i]))
	print(TP_rf[1,i])
	print(paste("False Positive rate for Protein",Proteins[i]))
	print((FP_rf[1,i])/(FP_rf[1,i] + TN_rf[1,i]))
	print(FP_rf[1,i])
}

print("Prediction of each protein based on KKNN")
for (i in 1:(length(Proteins)))
{
	print(paste("True Positive rate for Protein",Proteins[i]))
	print((TP_kknn[1,i])/(TP_kknn[1,i] + FN_kknn[1,i]))
	print(TP_kknn[1,i])
	print(paste("False Positive rate for Protein",Proteins[i]))
	print((FP_kknn[1,i])/(FP_kknn[1,i] + TN_kknn[1,i]))
	print(FP_kknn[1,i])
}

print("Prediction of each protein based on NN")
for (i in 1:(length(Proteins)))
{
	print(paste("True Positive rate for Protein",Proteins[i]))
	print((TP_nn[1,i])/(TP_nn[1,i] + FN_nn[1,i]))
	print(TP_nn[1,i])
	print(paste("False Positive rate for Protein",Proteins[i]))
	print((FP_nn[1,i])/(FP_nn[1,i] + TN_nn[1,i]))
	print(FP_nn[1,i])
}

print("Prediction of each protein based on NB")
for (i in 1:(length(Proteins)))
{
	print(paste("True Positive rate for Protein",Proteins[i]))
	print((TP_nb[1,i])/(TP_nb[1,i] + FN_nb[1,i]))
	print(TP_nb[1,i])
	print(paste("False Positive rate for Protein",Proteins[i]))
	print((FP_nb[1,i])/(FP_nb[1,i] + TN_nb[1,i]))
	print(FP_nb[1,i])
}
...
for(class in 1:8)
{
	...
	{
		print(paste("Protein",Proteins[pro]))
		print(RES[class,pro])
	}
}