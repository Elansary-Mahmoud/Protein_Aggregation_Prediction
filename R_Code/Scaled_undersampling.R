...
Data_Set = Query();
scaled_data_set = scale(Data_Set[,-c(1,2,18,21,22)],center=TRUE,scale=TRUE) 
scaled_data_set = as.data.frame(cbind( Data_Set[,1:2], scaled_data_set ,Data_Set[,c(18,21,22)]))
Data_Set = scaled_data_set
...
#save(list = ls(all=TRUE), file = "scaled_undersampling.RData")
