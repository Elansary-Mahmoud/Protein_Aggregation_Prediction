...
Data_Set = Query();
Proteins = c('HypF-N','P53','PAH','PTEN','alpha-GalA','b2m')
Short_Names =  c('HypF','P53','PAH','PTEN','A_GalA','b2m')
...
NEW_TMP = rbind(HypF_YES,P53_YES,PAH_YES,PTEN_YES,A_GalA_YES,b2m_YES,HypF_NO,P53_NO,PAH_NO,PTEN_NO,A_GalA_NO,b2m_NO)
...
#save(list = ls(all=TRUE), file = "Balanced_withoutAcp.RData")
